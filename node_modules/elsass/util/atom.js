...
class Atom {
  ...
  constructor (args) {
    ...
    this.siblings = args.siblings // 兄弟
    this.children = args.children // 孩子
    this.children_atoms = args.children_atoms || [] // 孩子atom数组
    this.ancestors = args.ancestors // 祖先
    this.root = args.root
    this.display = 1 // 用于判断节点是否被显示(TODO: 将来要合并到 status 中)
    this.expanded = 0 // 用于判断节点是否展开其子节点(TODO: 将来要合并到下方的 status 中)
